...
extension AudioFileConverter {
	@discardableResult static public func convert(wav url: URL, toM4A outputURL: URL? = nil, deleteSource: Bool = true) async throws -> URL {
		...
		let output = outputURL ?? url.deletingPathExtension().appendingPathExtension("m4a")
